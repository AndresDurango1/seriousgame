...
<body>
    ...
    <header>
        ...
        <div class="user-info">
            <img src="../recursos/img/img.PNG" alt="Avatar de Usuario" class="avatar">
            <span>(#usuario)</span>
        </div>
        <nav class="nav-icons">
        ...
        <section class="main-content">
            ...
            <section class="top-players">
                <div class="player-card">
                    <img src="../recursos/img/img.PNG" alt="Avatar" class="player-avatar">
                    <p>@SkyW</p>
                    
                </div>
                <div class="player-card first">
                    <img src="../recursos/img/img2.PNG" alt="Avatar" class="player-avatar">
                    <p>@Aethr</p>
                </div>
                <div class="player-card">
                    <img src="../recursos/img/img3.PNG" alt="Avatar" class="player-avatar">
                    <p>@Elmnt</p>
                </div>
            </section>
    ...
    <script>
        ...
        function actualizarDatos() {
            // Redirigir a la página de actualización o realizar alguna acción
            alert("Redirigiendo a la página de actualización de datos personales...");
